...
class NFL:
    ...
    # ESPN Efficiency
        ...
        features = [team1points, team2points, team1TORating, 
                    team2TORating, team1RushMultiplier, team2RushMultiplier, 
...
featureNames = ['team1points', 'team2points', 'team1TORating', 
                'team2TORating', 'team1RushMultiplier', 'team2RushMultiplier',
                'team1AdjRushRating', 'team2AdjRushRating', 'team1PassMultiplier', 
                'team2PassMultiplier', 'team1AdjPassRating', 'team2AdjPassRating', 
                'FPI_diff', 'SOS_diff', 'AVGWP',
...
# X_train = df_all_seasons.iloc[-257:][featureNames]
# Y_train = df_all_seasons.iloc[-257:]['spread']
# X_test = df_all_seasons.head(len(df_all_seasons) - 257)[featureNames]
# Y_test = df_all_seasons.head(len(df_all_seasons) - 257)['spread']
